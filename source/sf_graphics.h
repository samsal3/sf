...
SF_EXTERNAL sf_graphics_renderer *
sf_graphics_create_renderer(sf_arena *arena, sf_graphics_renderer_description *description);

SF_EXTERNAL void
sf_graphics_destroy_renderer(sf_graphics_renderer *renderer);

SF_EXTERNAL sf_handle
sf_graphics_create_texture(
    sf_graphics_renderer     *renderer,
    sf_graphics_texture_type  type,
    sf_graphics_format	      format,
    sf_graphics_sample_count  samples,
    sf_graphics_texture_usage usage,
...
SF_EXTERNAL void
sf_graphics_destroy_texture(sf_graphics_renderer *renderer, sf_handle handle);

SF_EXTERNAL sf_handle
sf_graphics_create_command_buffer(sf_graphics_renderer *renderer, sf_bool transient);

SF_EXTERNAL void
sf_graphics_destroy_command_buffer(sf_graphics_renderer *renderer, sf_handle handle);
...
SF_EXTERNAL void
sf_graphics_destroy_render_target(sf_graphics_renderer *renderer, sf_handle handle);
...
SF_EXTERNAL void
sf_graphics_destroy_pipeline(sf_graphics_renderer *renderer, sf_handle handle);
